...
## Recommendation
- Create a new contract as a temporary place to store the accrued premium, and then deliver it to the ``ProtectionPool`` with a constant vesting speed to lower the incentive of a quick profit by sandwich attack. 
